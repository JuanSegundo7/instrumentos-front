...
import { fas, faBars, faGuitar, faUser, faCloud, faShoppingCart, faHeart} from '@fortawesome/free-solid-svg-icons'

library.add(fas, faBars, faGuitar, faUser, faCloud, faShoppingCart, faHeart)
